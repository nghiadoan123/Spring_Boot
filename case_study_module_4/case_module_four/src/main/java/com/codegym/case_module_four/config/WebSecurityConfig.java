...
import com.codegym.case_module_four.service.user.UserDetailsServiceImpl;
...
//        String password = bCryptPasswordEncoder.encode("123123");
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/userInfo", "/customer/**","/home/**")
                .access("hasAnyRole('ROLE_USER', 'ROLE_ADMIN')");

        http.authorizeRequests()
                .antMatchers("/admin", "/employee/**" ,"/contract/**", "/service/**","/home/**")
